...
#Array principal
#Array = [99,56,32,1,34,54,87,76,65,54]
Array = []


#iteración que llena el arreglo con números aleatorios
...
def MergeSort(Array):
	...
	print()
	print()
	print("2.-		",left_l," ",left_r," ",right_l," ",right_r)
	print()
	...
	print()
	print("3.-		",left_l," ",left_r," ",right_l," ",right_r)
	print()
...
print()
print("Arreglo ordenado --->  ",MergeSort(Array))
print()
